 ...
 * Time: 1:00 AM
 */
namespace Bancario\Util\Tradding;
/**
 * Class Coinigy
...
class Coinigy
{
    use \Bancario\Traits\Tradding\Config;
    ...
    function __construct()
    {
        ...
        $this->coinigy_api_key = \Bancario\Traits\Tradding\Config::bowhead_config('COINIGY_API');
        $this->coinigy_api_secret = \Bancario\Traits\Tradding\Config::bowhead_config('COINIGY_SEC');
     ...
     */
    public function addOrder($order_auth_id, $order_exchange_id, $order_mkt_id, $order_type_id, $price_type_id, $limit_price, $stop_price, $order_quantity)
    {
        $post_arr = array();
        $post_arr["auth_id"] = $order_auth_id;
        $post_arr["exchange_id"] = $order_exchange_id;
