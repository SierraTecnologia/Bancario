 ...
 *
 *              use Bancario\Util\Tradding Ledger class for all buy and sell functions so ledger is properly updated.
 *              use Bancario\Util\Tradding Math class for all math functions not in trader extension.
 */
class Whaleclub
{
    /**
