 ...
 */
final class TickerEntity extends AbstractEntity
{
    public $model = \Bancario\Models\Tradding\Ticker::class;

    /**
     *   "open" => "55709.16000000"
     *   "high" => "55717.00000000"
     *   "low" => "55702.51000000"
     *   "close" => "55703.25000000"
     *   "volume" => "650475.68715350"
     *   "openTime" => 1613777400000
     *   "closeTime" => 1613777459999
     *   "assetVolume" => "11.67691200"
     *   "baseVolume" => "650475.68715350"
     *   "trades" => 285
     *   "assetBuyVolume" => "4.27595800"
     *   "takerBuyVolume" => "238198.22688209"
     *   "ignored" => "0"
     */
    private $id;
    private $open;
    ...
    //  * @return $this
    //  */
    // private function setId(int $id): TickerEntity
    // {
    //     $this->id = $id;
    ...
    //  * @return $this
    //  */
    // private function setCreatedByUserId(int $createdByUserId): TickerEntity
    // {
    ...
    //  * @return $this
    //  */
    // private function setDescription(string $path): TickerEntity
    // {
    ...
    //  * @return $this
    //  */
    // private function setPhoto(PhotoEntity $photo): TickerEntity
    // {
    //     $this->photo = $photo;
    ...
    //  * @return $this
    //  */
    // public function setTags(Collection $tags): TickerEntity
    // {
    //     $this->tags = $tags;
    ...
    //  * @return $this
    //  */
    // private function setCreatedAt(Carbon $createdAt): TickerEntity
    // {
    ...
    //  * @return $this
    //  */
    // private function setUpdatedAt(Carbon $updatedAt): TickerEntity
    // {
    ...
    //  * @return $this
    //  */
    // private function setPublishedAt(?Carbon $publishedAt): TickerEntity
    // {
