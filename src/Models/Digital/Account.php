...
namespace Bancario\Models\Digital;

use Support\Models\Base;
use Muleta\Traits\Models\ComplexRelationamentTrait;
use Integrations\Models\Integration;
use Bancario\Models\Actors\Business;
...
class Account extends Base
{
    ...
    {
        return $this->morphedByMany(\Illuminate\Support\Facades\Config::get('sitec-tools.models.business', \Bancario\Models\Actors\Business::class), 'accountable');
    }
    ...
    {
        return $this->morphedByMany(\Illuminate\Support\Facades\Config::get('sitec.core.models.person', \Bancario\Models\Actors\Person::class), 'accountable');
    }
